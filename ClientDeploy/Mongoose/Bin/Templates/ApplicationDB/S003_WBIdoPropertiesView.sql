/* $Header: /Tools/SQLScripts/ApplicationDB/Views/WBIdoPropertiesView.sql 1     12/05/12 2:58p Bharbron $ */
/*
***************************************************************
*                                                             *
*                           NOTICE                            *
...
***************************************************************
*/
/* $Archive: /Tools/SQLScripts/ApplicationDB/Views/WBIdoPropertiesView.sql $
 *
 * CoreDev 1 RS5349 Bharbron Wed Dec 05 14:58:11 2012
 * RS5349 - Add WB to Framework
*
* $NoKeywords: $
*/

CREATE VIEW WBIdoPropertiesView
AS
WITH CollChain (
  BaseCollectionName
, ClimbCollName
