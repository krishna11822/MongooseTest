/* $Header: /Tools/SQLScripts/Templates/ApplicationDB/S001_ido.CustomAssembly.sql 1     3/30/07 3:38p Tblosser $ */
/*
...
*/
CREATE VIEW ido.CustomAssembly
AS
SELECT
  AssemblyName
, DevelopmentFlag
...
FROM ToolsDev_600_Objects.dbo.CustomAssembly
