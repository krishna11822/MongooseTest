/* $Header: /Tools/SQLScripts/Templates/ApplicationDB/S001_ido.MethodResultSets.sql 1     3/30/07 3:38p Tblosser $ */
/*
...
*/
CREATE VIEW ido.MethodResultSets
AS
SELECT
  CollectionName
, MethodName
...
, UpdatedBy
, CreateDate
FROM ToolsDev_600_Objects.dbo.MethodResultSets
