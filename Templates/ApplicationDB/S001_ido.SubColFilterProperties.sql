/* $Header: /Tools/SQLScripts/Templates/ApplicationDB/S001_ido.SubColFilterProperties.sql 1     3/30/07 3:38p Tblosser $ */
/*
...
*/
CREATE VIEW ido.SubColFilterProperties
AS
SELECT
  CollectionName
, PropertyName
...
, UpdatedBy
, CreateDate
FROM ToolsDev_600_Objects.dbo.SubColFilterProperties
