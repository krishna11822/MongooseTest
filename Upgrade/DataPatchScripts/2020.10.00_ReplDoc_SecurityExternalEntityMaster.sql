...
VALUES (
   N'SecurityExternalEntityMaster',--DocumentName
   150,--ElementSequence
   N'BODVERB()BODNOUN()/DataArea/BODNOUN()/EntityImage',--BODTagName
   N'PropertyTag',--ValueSourceType
   N'Images',--IDOPropertyName
   NULL,--ValueExpression
   0,--IsToLogicalId
   NULL,--SubColLinkBy
   NULL,--SubColFilter
   N'UPD(LoadESBExternalEntityMasterImageSp(Code, MediaType, Description, DocumentObject, P2, MESSAGE))',--SubColInsUpdDelOverride
   NULL,--SubColCustomLoadMethod
   NULL,--DynamicSubcollectionIDOName
   N'External Entity contains multiple images for things like EMail and Login Logos.',--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'2c567ebc-76e2-4109-8d64-585894aae6e9',--RowPointer
   NULL--ExclusionPropertyName
)
INSERT INTO ReplDocElement
(DocumentName,ElementSequence,BODTagName,ValueSourceType,IDOPropertyName,ValueExpression,IsToLogicalId,SubColLinkBy,SubColFilter,SubColInsUpdDelOverride,SubColCustomLoadMethod,DynamicSubcollectionIDOName,DocumentationNotes,DocumentationSchema,AccessAs,RowPointer,ExclusionPropertyName)
VALUES (
   N'SecurityExternalEntityMaster',--DocumentName
   160,--ElementSequence
   N'BODVERB()BODNOUN()/DataArea/BODNOUN()/EntityImage/EmbeddedData',--BODTagName
   N'PropertyTag',--ValueSourceType
   N'Images.DocumentObject',--IDOPropertyName
   NULL,--ValueExpression
   0,--IsToLogicalId
   NULL,--SubColLinkBy
   NULL,--SubColFilter
   ...
   NULL,--SubColCustomLoadMethod
   NULL,--DynamicSubcollectionIDOName
   N'The actual image data, or an empty XML element.',--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'a04285c6-bc20-4b58-9070-1a15698c79f0',--RowPointer
   NULL--ExclusionPropertyName
)
INSERT INTO ReplDocElement
(DocumentName,ElementSequence,BODTagName,ValueSourceType,IDOPropertyName,ValueExpression,IsToLogicalId,SubColLinkBy,SubColFilter,SubColInsUpdDelOverride,SubColCustomLoadMethod,DynamicSubcollectionIDOName,DocumentationNotes,DocumentationSchema,AccessAs,RowPointer,ExclusionPropertyName)
VALUES (
   N'SecurityExternalEntityMaster',--DocumentName
   170,--ElementSequence
   N'BODVERB()BODNOUN()/DataArea/BODNOUN()/AuthorizedApplications',--BODTagName
   N'Literal',--ValueSourceType
   NULL,--IDOPropertyName
   NULL,--ValueExpression
   0,--IsToLogicalId
   ...
   NULL,--SubColCustomLoadMethod
   NULL,--DynamicSubcollectionIDOName
   N'Set of "Authorized Applications" for this External Entity.',--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'419b7483-fcbd-478e-b662-5c4ab30b5ee7',--RowPointer
   NULL--ExclusionPropertyName
)
INSERT INTO ReplDocElement
(DocumentName,ElementSequence,BODTagName,ValueSourceType,IDOPropertyName,ValueExpression,IsToLogicalId,SubColLinkBy,SubColFilter,SubColInsUpdDelOverride,SubColCustomLoadMethod,DynamicSubcollectionIDOName,DocumentationNotes,DocumentationSchema,AccessAs,RowPointer,ExclusionPropertyName)
VALUES (
   N'SecurityExternalEntityMaster',--DocumentName
   180,--ElementSequence
   N'BODVERB()BODNOUN()/DataArea/BODNOUN()/AuthorizedApplications/Application',--BODTagName
   N'PropertyTag',--ValueSourceType
   N'AuthorizedApplications',--IDOPropertyName
   NULL,--ValueExpression
   0,--IsToLogicalId
   NULL,--SubColLinkBy
   NULL,--SubColFilter
   N'UPD(LoadESBExternalEntityMasterAuthAppSp(Code,ApplicationCode, ApplicationLid, P2, MESSAGE))',--SubColInsUpdDelOverride
   NULL,--SubColCustomLoadMethod
   NULL,--DynamicSubcollectionIDOName
   N'A particular "Authorized Application" for this External Entity.',--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'0e5c5e3a-e2e3-4012-8a1d-863e883bcd74',--RowPointer
   NULL--ExclusionPropertyName
)
INSERT INTO ReplDocElement
(DocumentName,ElementSequence,BODTagName,ValueSourceType,IDOPropertyName,ValueExpression,IsToLogicalId,SubColLinkBy,SubColFilter,SubColInsUpdDelOverride,SubColCustomLoadMethod,DynamicSubcollectionIDOName,DocumentationNotes,DocumentationSchema,AccessAs,RowPointer,ExclusionPropertyName)
VALUES (
   N'SecurityExternalEntityMaster',--DocumentName
   190,--ElementSequence
   N'BODVERB()BODNOUN()/DataArea/BODNOUN()/AuthorizedApplications/Application/ApplicationLID',--BODTagName
   N'PropertyTag',--ValueSourceType
   N'AuthorizedApplications.ApplicationLid',--IDOPropertyName
   NULL,--ValueExpression
   0,--IsToLogicalId
   NULL,--SubColLinkBy
   NULL,--SubColFilter
   ...
   NULL,--SubColCustomLoadMethod
   NULL,--DynamicSubcollectionIDOName
   N'Authorized Application LID',--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'51097b52-fa6f-49fb-b215-79bc41092bd4',--RowPointer
   NULL--ExclusionPropertyName
)
INSERT INTO ReplDocElement
(DocumentName,ElementSequence,BODTagName,ValueSourceType,IDOPropertyName,ValueExpression,IsToLogicalId,SubColLinkBy,SubColFilter,SubColInsUpdDelOverride,SubColCustomLoadMethod,DynamicSubcollectionIDOName,DocumentationNotes,DocumentationSchema,AccessAs,RowPointer,ExclusionPropertyName)
VALUES (
   N'SecurityExternalEntityMaster',--DocumentName
   200,--ElementSequence
   N'BODVERB()BODNOUN()/DataArea/BODNOUN()/AuthorizedApplications/Application/AuthorizedComponent',--BODTagName
   N'PropertyTag',--ValueSourceType
   N'AuthorizedApplications.ApplicationCode',--IDOPropertyName
   NULL,--ValueExpression
   0,--IsToLogicalId
   NULL,--SubColLinkBy
   NULL,--SubColFilter
   ...
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'd6027799-c170-4708-97d9-3caf217f9928',--RowPointer
   NULL--ExclusionPropertyName
)
...
VALUES (
   N'SecurityExternalEntityMaster',--DocumentName
   N'type',--AttributeName
   N'PropertyTag',--ValueSourceType
   0,--IncludeForNullValuedElement
   N'Images.Description',--IDOPropertyName
   NULL,--ValueExpression
   N'String describing the purpose of this image, like "EmailLogo" or "LoginLogo".',--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'2c567ebc-76e2-4109-8d64-585894aae6e9',--ElementRowPointer
   N'3d337b25-6603-426f-ae41-a04f10051078'--RowPointer
)
INSERT INTO ReplDocAttribute
(DocumentName,AttributeName,ValueSourceType,IncludeForNullValuedElement,IDOPropertyName,ValueExpression,DocumentationNotes,DocumentationSchema,AccessAs,ElementRowPointer,RowPointer)
VALUES (
   N'SecurityExternalEntityMaster',--DocumentName
   N'mimeCode',--AttributeName
   N'PropertyTag',--ValueSourceType
   0,--IncludeForNullValuedElement
   N'Images.MediaType',--IDOPropertyName
   NULL,--ValueExpression
   N'The media type, like "image/png".',--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'a04285c6-bc20-4b58-9070-1a15698c79f0',--ElementRowPointer
   N'196ef7a6-8e4e-43cc-8dd3-98d592e72430'--RowPointer
)
...
VALUES (
   ...
   N'Sync',--BODVerb
   N'Core',--AccessAs
   N'20200905 13:22:58.470',--CreateDate
   N'20200905 13:22:58.470'--RecordDate
)
