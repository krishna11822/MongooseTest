...
AND o.AccessAs = 'Core'
DELETE FROM ReplDocOutbound WHERE DocumentName = 'SecurityRoleMaster'  AND AccessAs = 'Core'
DELETE FROM ReplDocInbound WHERE DocumentName = 'SecurityRoleMaster'  AND AccessAs = 'Core'
DELETE FROM ReplDocAttribute WHERE DocumentName = 'SecurityRoleMaster'  AND AccessAs = 'Core'
DELETE FROM ReplDocElement WHERE DocumentName = 'SecurityRoleMaster'  AND AccessAs = 'Core'
DELETE FROM ReplDocument WHERE DocumentName = 'SecurityRoleMaster' AND AccessAs = 'Core'
...
VALUES (
   ...
   NULL,--SubColCustomLoadMethod
   NULL,--DynamicSubcollectionIDOName
   N'External group name',--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
...
VALUES (
   ...
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'eebbdcbe-6602-48a7-8324-73f43e5bfc24',--RowPointer
   NULL--ExclusionPropertyName
)
INSERT INTO ReplDocElement
(DocumentName,ElementSequence,BODTagName,ValueSourceType,IDOPropertyName,ValueExpression,IsToLogicalId,SubColLinkBy,SubColFilter,SubColInsUpdDelOverride,SubColCustomLoadMethod,DynamicSubcollectionIDOName,DocumentationNotes,DocumentationSchema,AccessAs,RowPointer,ExclusionPropertyName)
VALUES (
   N'SecurityRoleMaster',--DocumentName
   140,--ElementSequence
   N'BODVERB()BODNOUN()/DataArea/BODNOUN()/SecurityPermission',--BODTagName
   N'PropertyTag',--ValueSourceType
   N'ESBSecurityPermissionsMasterViews',--IDOPropertyName
   NULL,--ValueExpression
   0,--IsToLogicalId
   N'GroupName=GroupName',--SubColLinkBy
   NULL,--SubColFilter
   NULL,--SubColInsUpdDelOverride
   NULL,--SubColCustomLoadMethod
   NULL,--DynamicSubcollectionIDOName
   N'Roll/Groups Security Permission',--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'48369e86-8c0d-477a-8d2e-aab68e2fca51',--RowPointer
   NULL--ExclusionPropertyName
)
INSERT INTO ReplDocElement
(DocumentName,ElementSequence,BODTagName,ValueSourceType,IDOPropertyName,ValueExpression,IsToLogicalId,SubColLinkBy,SubColFilter,SubColInsUpdDelOverride,SubColCustomLoadMethod,DynamicSubcollectionIDOName,DocumentationNotes,DocumentationSchema,AccessAs,RowPointer,ExclusionPropertyName)
VALUES (
   N'SecurityRoleMaster',--DocumentName
   150,--ElementSequence
   N'BODVERB()BODNOUN()/DataArea/BODNOUN()/SecurityPermission/ID',--BODTagName
   N'PropertyTag',--ValueSourceType
   ...
   NULL,--SubColCustomLoadMethod
   NULL,--DynamicSubcollectionIDOName
   N'Roll/Groups Security Permission ID',--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'fa7c8118-7c0b-41cd-9552-d5f73a890cd7',--RowPointer
   NULL--ExclusionPropertyName
)
INSERT INTO ReplDocElement
(DocumentName,ElementSequence,BODTagName,ValueSourceType,IDOPropertyName,ValueExpression,IsToLogicalId,SubColLinkBy,SubColFilter,SubColInsUpdDelOverride,SubColCustomLoadMethod,DynamicSubcollectionIDOName,DocumentationNotes,DocumentationSchema,AccessAs,RowPointer,ExclusionPropertyName)
VALUES (
   N'SecurityRoleMaster',--DocumentName
   160,--ElementSequence
   N'BODVERB()BODNOUN()/DataArea/BODNOUN()/SecurityPermission/Description',--BODTagName
   N'PropertyTag',--ValueSourceType
   ...
   NULL,--SubColCustomLoadMethod
   NULL,--DynamicSubcollectionIDOName
   N'Description',--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'7416278b-f313-4db4-bd92-83a848547f8e',--RowPointer
   NULL--ExclusionPropertyName
)
...
VALUES (
   ...
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'eebbdcbe-6602-48a7-8324-73f43e5bfc24',--ElementRowPointer
   N'94d8e943-2954-4de2-b5d8-2853de140470'--RowPointer
)
INSERT INTO ReplDocAttribute
(DocumentName,AttributeName,ValueSourceType,IncludeForNullValuedElement,IDOPropertyName,ValueExpression,DocumentationNotes,DocumentationSchema,AccessAs,ElementRowPointer,RowPointer)
VALUES (
   ...
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'fa7c8118-7c0b-41cd-9552-d5f73a890cd7',--ElementRowPointer
   N'63f65ab4-c2a6-411b-b44f-90b2ea100ace'--RowPointer
)
INSERT INTO ReplDocAttribute
(DocumentName,AttributeName,ValueSourceType,IncludeForNullValuedElement,IDOPropertyName,ValueExpression,DocumentationNotes,DocumentationSchema,AccessAs,ElementRowPointer,RowPointer)
VALUES (
   ...
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'7416278b-f313-4db4-bd92-83a848547f8e',--ElementRowPointer
   N'8e287343-be26-43f7-81ad-20e876cfb64a'--RowPointer
)
...
VALUES (
   ...
   N'GroupName',--KeyList
   N'Adding or updating Groups',--DocumentationGenerationEvents
   N'Core',--AccessAs
   0,--EligibleForBackgroundManualRequest
   N'20180309 17:13:39.303',--CreateDate
   N'20180313 14:37:08.973',--RecordDate
   N'0e007478-e717-4ec4-9b81-3692a028e895'--RowPointer
)
