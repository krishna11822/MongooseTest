...
VALUES (
   ...
   N'CLM_ESBSecurityUserMaster2Sp(P(P1),P(P2))',--SupplementaryCustomLoadMethod
...
VALUES (
   ...
   N'PropertyTag',--ValueSourceType
   N'RefRecordDate',--IDOPropertyName
   NULL,--ValueExpression
   0,--IsToLogicalId
   NULL,--SubColLinkBy
   NULL,--SubColFilter
   ...
   NULL,--SubColCustomLoadMethod
   NULL,--DynamicSubcollectionIDOName
   N'Modification Date of Record',--DocumentationNotes
   N'usernames.recorddate',--DocumentationSchema
   N'Core',--AccessAs
...
VALUES (
   ...
   NULL,--SubColLinkBy
   NULL,--SubColFilter
   N'UPD(LoadESBSecurityUserMasterSecurityRoles3Sp(WorkstationLogin,GroupName,GroupDesc, LogicalId, MESSAGE))',--SubColInsUpdDelOverride
...
VALUES (
   ...
   NULL,--SubColFilter
   N'UPD(MethodNOOP())',--SubColInsUpdDelOverride
   NULL,--SubColCustomLoadMethod
   NULL,--DynamicSubcollectionIDOName
...
VALUES (
   ...
   N'PropertyTag',--ValueSourceType
   0,--IncludeForNullValuedElement
   N'ESBSecurityUserMasterSecurityRoleViews.LogicalId',--IDOPropertyName
   NULL,--ValueExpression
   NULL,--DocumentationNotes
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'ee003ac0-7680-4dff-8ecc-db602b9f5088',--ElementRowPointer
   N'21e7af7f-0ead-4bb4-ab32-86ea91510303'--RowPointer
)
INSERT INTO ReplDocAttribute
(DocumentName,AttributeName,ValueSourceType,IncludeForNullValuedElement,IDOPropertyName,ValueExpression,DocumentationNotes,DocumentationSchema,AccessAs,ElementRowPointer,RowPointer)
VALUES (
...
VALUES (
   ...
   N'UserId',--KeyList
   N'Adding or updating Users',--DocumentationGenerationEvents
   N'Core',--AccessAs
   0,--EligibleForBackgroundManualRequest
   N'20171130 08:24:29.190',--CreateDate
   N'20181210 18:36:39.533',--RecordDate
