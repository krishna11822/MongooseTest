...
***************************************************************
*/ 
-- RS8750 - add action expression to outbound logic.
...
VALUES (
   ...
   NULL,--SubColLinkBy
   NULL,--SubColFilter
   N'UPD(LoadESBSecurityUserMasterSecurityRoles2Sp(WorkstationLogin,GroupName,GroupDesc,Message))',--SubColInsUpdDelOverride
