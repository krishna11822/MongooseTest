/*$Header: /Tools/SQLScripts/Upgrade/DataPatchScripts/9.03.00_ReplDoc_SecurityPermissionMaster.sql 5     9/20/17 4:30p Jmorris $ */
/*
***************************************************************
*                                                             *
*                           NOTICE                            *
...
Delete f from ReplDocOutboundFilter f join ReplDocOutbound o on f.ReplDocOutboundRowPointer = o.RowPointer where o.DocumentName = 'SecurityPermissionMaster';
Delete From ReplDocOutbound Where DocumentName = 'SecurityPermissionMaster';
Delete From ReplDocInbound Where DocumentName = 'SecurityPermissionMaster';
Delete From ReplDocAttribute Where DocumentName = 'SecurityPermissionMaster';
Delete From ReplDocElement Where DocumentName = 'SecurityPermissionMaster';
Delete From ReplDocument Where DocumentName = 'SecurityPermissionMaster';
