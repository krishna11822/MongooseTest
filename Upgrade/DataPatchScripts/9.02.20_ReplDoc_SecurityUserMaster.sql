/*$Header: /Tools/SQLScripts/Upgrade/DataPatchScripts/9.02.20_ReplDoc_SecurityUserMaster.sql 11    9/20/17 4:29p Jmorris $ */
/*
***************************************************************
*                                                             *
*                           NOTICE                            *
...
FROM ReplDocOutbound AS rdo WHERE DocumentName = 'SecurityUserMaster'
DELETE f FROM ReplDocOutboundFilter f JOIN ReplDocOutbound o ON f.ReplDocOutboundRowPointer = o.RowPointer WHERE o.DocumentName = 'SecurityUserMaster'
DELETE FROM ReplDocOutbound WHERE DocumentName = 'SecurityUserMaster' 
DELETE FROM ReplDocInbound WHERE DocumentName = 'SecurityUserMaster'  
DELETE FROM ReplDocAttribute WHERE DocumentName = 'SecurityUserMaster'
DELETE FROM ReplDocElement WHERE DocumentName = 'SecurityUserMaster'  
DELETE FROM ReplDocument WHERE DocumentName = 'SecurityUserMaster';
...
VALUES (
   ...
   N'UPD(LoadESBSecurityUserMasterSp(WorkstationLogin,P2,Status,GivenName,FamilyName,UserName,EmailAddress,MESSAGE))',--SupplementaryInsUpdDelOverride
...
VALUES (
   ...
   NULL,--DocumentationSchema
   N'Core',--AccessAs
   N'8e2a5ac9-15d0-48e3-9160-4b16fcd0e7b0',--RowPointer
   NULL--ExclusionPropertyName
)
INSERT INTO ReplDocElement
(DocumentName,ElementSequence,BODTagName,ValueSourceType,IDOPropertyName,ValueExpression,IsToLogicalId,SubColLinkBy,SubColFilter,SubColInsUpdDelOverride,SubColCustomLoadMethod,DynamicSubcollectionIDOName,DocumentationNotes,DocumentationSchema,AccessAs,RowPointer,ExclusionPropertyName)
VALUES (
   ...
   N'Core',--AccessAs
   N'd2ca9479-d987-4170-8dab-0fe49136b6f7',--RowPointer
   NULL--ExclusionPropertyName
)
INSERT INTO ReplDocElement
(DocumentName,ElementSequence,BODTagName,ValueSourceType,IDOPropertyName,ValueExpression,IsToLogicalId,SubColLinkBy,SubColFilter,SubColInsUpdDelOverride,SubColCustomLoadMethod,DynamicSubcollectionIDOName,DocumentationNotes,DocumentationSchema,AccessAs,RowPointer,ExclusionPropertyName)
VALUES (
   ...
   N'Core',--AccessAs
   N'236a9302-c17a-44b5-888f-4d85119c6fd8',--RowPointer
   NULL--ExclusionPropertyName
)
...
VALUES (
   ...
   N'20150721 15:33:26.660',--CreateDate
   N'20150721 15:33:26.667',--RecordDate
...
VALUES (
   ...
   N'Sync',--BODVerb
   N'Core',--AccessAs
   N'20150721 15:33:26.663',--CreateDate
   N'20150721 15:33:26.663'--RecordDate
)
