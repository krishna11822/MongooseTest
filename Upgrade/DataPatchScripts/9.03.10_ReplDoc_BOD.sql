/*$Header: /Tools/SQLScripts/Upgrade/DataPatchScripts/9.03.10_ReplDoc_BOD.sql 1     8/02/17 1:08p Jmorris $ */
/*
***************************************************************
*                                                             *
*                           NOTICE                            *
...
AND o.AccessAs = 'BaseSyteLine'
DELETE FROM ReplDocOutbound WHERE DocumentName = 'BOD'  AND AccessAs = 'BaseSyteLine'
DELETE FROM ReplDocInbound WHERE DocumentName = 'BOD'  AND AccessAs = 'BaseSyteLine'
DELETE FROM ReplDocAttribute WHERE DocumentName = 'BOD'  AND AccessAs = 'BaseSyteLine'
DELETE FROM ReplDocElement WHERE DocumentName = 'BOD'  AND AccessAs = 'BaseSyteLine'
DELETE FROM ReplDocument WHERE DocumentName = 'BOD' AND AccessAs = 'BaseSyteLine';
...
DELETE f FROM ReplDocOutboundFilter f JOIN ReplDocOutbound o ON f.ReplDocOutboundRowPointer = o.RowPointer WHERE o.DocumentName = 'BOD'
AND o.AccessAs = 'Core'
DELETE FROM ReplDocOutbound WHERE DocumentName = 'BOD'  AND AccessAs = 'Core'
DELETE FROM ReplDocInbound WHERE DocumentName = 'BOD'  AND AccessAs = 'Core'
DELETE FROM ReplDocAttribute WHERE DocumentName = 'BOD'  AND AccessAs = 'Core'
DELETE FROM ReplDocElement WHERE DocumentName = 'BOD'  AND AccessAs = 'Core'
DELETE FROM ReplDocument WHERE DocumentName = 'BOD' AND AccessAs = 'Core';
