...
DEST(46)', N'go on to the ido if columns done')
...
PARMS(P(Batch, 1, "TableIDOName"), E(IdoProject), V(NullValue), E(UserID), V(nullvalue), "0", "o" + P(Batch, 1, "TableIDOName"), RV(InsertMessage))', N'create the ido')
