...
-- IDO from IONAPI Wizard
IF EXISTS (SELECT 1 FROM WSFormWizards WHERE WizardName = 'IDOFromIONAPIWizard' AND CategoryName = 'ExtDatasource')
DELETE FROM WSFormWizards WHERE WizardName = 'IDOFromIONAPIWizard' AND CategoryName = 'ExtDatasource'
GO
...
, 'ExtDatasource'
, 'Core'
, 'mIDOFromIONAPIWizard_ExtDatasource'     
, 'WSFormWizardIDOFromIONAPI'
, 'NULL'
, 1
)
GO
